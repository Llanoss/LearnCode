const forums = []; // Arreglo para almacenar foros
        ...
        function createForum() {
            ...
            if (creatorName && forumTitle && forumDescription) {
                const forumId = Date.now(); // ID único para cada foro
                forums.push({ creatorName, forumTitle, forumDescription, forumId }); // Almacenar el foro
        ...
        function renderForum({ creatorName, forumTitle, forumDescription, forumId }) {
